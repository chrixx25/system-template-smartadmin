var com_github_culmat_jsTreeTable =  (function(){
    ...
    function treeTable(table)
    {
        ...
        let imgExpand = `<button class="btn btn-info btn-sm btn-icon waves-effect waves-themed btn-plus">
                            <i class="fa fa-plus"></i>
                        </button>`;
        let imgCollapse = `<button id="state" class="btn btn-danger btn-sm btn-icon waves-effect waves-themed btn-plus">
